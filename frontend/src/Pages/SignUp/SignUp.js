        ...
        <section className="signup">
          <section className="left-section">
            <h1 className="signinheading">
              Sign In to <span className="primary-blue-color">Book </span> Spot
            </h1>
            <p className="signinpara">
              Book Spot is the leading destination to find & showcase creative
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <Link to="/forgetpassword">
                <p className="forget-password-btn" style={{ color: "#5C2E88" }}>
                  forget Password?
                </p>
              </Link>
