  ...
  return (
    <>
...

      {
        ...
        <PostProduct reviews={reviews} revState={revState} user={user} isAuthenticated={isAuthenticated} art={art} productimg={productimg} profilepic={propic} username="John Birmingham" userdate="25 December 2019" />
